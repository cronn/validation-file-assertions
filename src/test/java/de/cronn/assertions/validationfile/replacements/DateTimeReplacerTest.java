...
class DateTimeReplacerTest {
  ...
  void testReturnsInputObjectIfNoMatchIsFound() throws Exception {
    ...
    DateTimeReplacer dateTimeReplacer =
        new DateTimeReplacer(
            Pattern.compile("foo (?<DateTime>.+?) bar"), ISO_OFFSET_DATE_TIME, ISO_LOCAL_DATE);
  ...
  void testReplaceDateTimeStandalone() throws Exception {
    ...
    DateTimeReplacer dateTimeReplacer =
        new DateTimeReplacer(
            Pattern.compile("(?<DateTime>.+)"), ISO_OFFSET_DATE_TIME, ISO_LOCAL_DATE);
  ...
  void testReplaceDateTimeEncapsulatedNoMatch() throws Exception {
    ...
    DateTimeReplacer dateTimeReplacer =
        new DateTimeReplacer(
            Pattern.compile("foo (?<DateTime>.+?) bar"),
  ...
  void testReplaceMultipleDateTime() throws Exception {
    ...
    DateTimeReplacer dateTimeReplacer =
        new DateTimeReplacer(
            Pattern.compile("x (?<DateTime>.+?) x"), ISO_OFFSET_DATE_TIME, ISO_LOCAL_DATE);
  ...
  void testReplaceDateTimeInXml() {
    String xml =
        "<someThing>foo</someThing> <dateTime1>2017-09-04T15:39:31.31+02:00</dateTime1> "
    ...
    String expected =
        "<someThing>foo</someThing> <dateTime1>2017-09-04</dateTime1> "
            + "<dateTime2>2017-09-04T15:39:31.31+02:00</dateTime2> <someThing>bar</someThing>";
