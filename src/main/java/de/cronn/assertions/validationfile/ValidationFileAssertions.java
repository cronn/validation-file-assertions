...
public interface ValidationFileAssertions {
      ...
      failedAssertionsCollector.executeAndHandleFailedAssertion(
          () -> {
            FileBasedComparisonUtils.compareActualWithFileHidden(
                actualOutput, filename, normalizer);
            return null;
          });
    } else {
  ...
  default void assertWithFileWithSuffix(
      String actualString, String suffix, FileExtension extension) {
  ...
  default void assertWithFileWithSuffix(
    ...
    assertWithFile(
        actualString,
        getValidationFileName(getTestName(), suffix, extension),
        validationNormalizer);
  }

  default void assertWithFile(
      String actualOutput, ValidationNormalizer validationNormalizer, FileExtension extension) {
    assertWithFile(
        actualOutput, getValidationFileName(getTestName(), extension), validationNormalizer);
  }
  ...
  default void assertWithFileWithSuffix(
      String actualString, ValidationNormalizer validationNormalizer, String suffix) {
  ...
  default void assertWithJsonFileWithSuffix(
      String actualJsonString, ValidationNormalizer validationNormalizer, String suffix) {
    assertWithFileWithSuffix(actualJsonString, validationNormalizer, suffix, FileExtensions.JSON);
  }

  default void assertWithJsonFile(
      String actualJsonString, ValidationNormalizer validationNormalizer) {
  ...
  default void assertWithXmlFileWithSuffix(
      String actualXmlString, ValidationNormalizer validationNormalizer, String suffix) {
    assertWithFileWithSuffix(actualXmlString, validationNormalizer, suffix, FileExtensions.XML);
  }

  default void assertWithXmlFile(
      String actualXmlString, ValidationNormalizer validationNormalizer) {
